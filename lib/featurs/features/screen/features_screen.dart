...
class _FeaturesScreenState extends State<FeaturesScreen> {
  ...
  void _navigateToDetail(Equipment item) {
    Widget screen;
    switch (item.name) {
      case "Treadmill":
        screen = TreadmillScreen(item: item);
        break;
      case "Dumbbells":
        screen = DumbbellsScreen(item: item);
        break;
      case "Smith Machine":
        screen = SmithScreen(item: item);
        break;
      case "Yoga Mat":
        screen = YogaMatScreen(item: item);
        break;
      case "Cable Station":
        screen = CableScreen(item: item);
        break;
      case "Kettlebells":
        screen = KettlebellsScreen(item: item);
        break;
      case "Rowing Machine":
        screen = RowingMachineScreen(item: item);
        break;
      default:
        return;
    }
